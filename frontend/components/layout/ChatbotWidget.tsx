  ...
  return (
    <>
      ...
      <Button
        ...
        className="fixed bottom-4 left-4 z-[120] h-12 w-12 rounded-full bg-primary p-0 shadow-lg hover:bg-primary/90"
      ...
      {/* Chat Widget */}
      {isOpen && (
        <div className="fixed bottom-20 left-4 z-[119] flex h-96 w-80 max-w-[calc(100vw-2rem)] flex-col rounded-lg border border-gray-200 bg-white shadow-xl sm:h-[32rem] sm:w-96">
          {/* Header */}
          <div className="flex-shrink-0 rounded-t-lg bg-primary p-4 text-white">
            <h3 className="text-sm font-semibold">PickMyUni Assistant</h3>
            <p className="text-xs opacity-90">
              Ask me about Australian universities
            </p>
          </div>
              ...
              <ConversationContent className="space-y-3">
                ...
                {showWelcomeMessage && (
                  <Message from="assistant">
                    <MessageContent>
                      <Response>
                        Hello! I'm here to help you find the perfect university
                        in Australia. How can I assist you today?
                      </Response>
                    </MessageContent>
