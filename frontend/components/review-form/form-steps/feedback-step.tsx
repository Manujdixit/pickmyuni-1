...
import { StarRating } from "@/components/review-form/star-rating";
import { ImageUpload } from "@/components/review-form/image-upload";
      ...
      <div className="space-y-12">
        ...
        <div className="space-y-2">
          <Label className="flex items-center gap-2 text-sm font-medium">
            ...
            Review Title <span className="text-brand-primary">*</span>
          </Label>
          <Controller
            name="reviewTitle"
            control={control}
        ...
        <div className="space-y-4">
          <Label className="text-brand-primary flex items-center gap-2 text-lg font-semibold">
