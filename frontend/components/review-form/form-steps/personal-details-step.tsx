      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <div className="space-y-2">
          ...
          >
            ...
            Email ID <span className="text-brand-primary">*</span>
          </Label>
          <Controller
            name="email"
            control={control}
        ...
        <div className="space-y-2">
          ...
          <Controller
            ...
            control={control}
            render={({ field }) => (
              <div className="z-10 w-full rounded-md p-[1px] focus-within:ring-1 focus-within:ring-green-800">
                <PhoneInput
                  country="in"
                  value={field.value}
                  onChange={(phone) => {
        ...
        <div className="space-y-2">
          <Label className="flex items-center gap-2 text-sm font-medium">
            ...
            Country Of Origin <span className="text-blue-600">*</span>
          </Label>
          <Controller
        ...
        */}
        ...
        <div className="space-y-2">
          <Label className="flex items-center gap-2 text-sm font-medium">
            <Users className="text-brand-primary h-4 w-4" />I am{" "}
        ...
        {iAmValue === "student" && (
          <div className="space-y-2">
            <Label
              ...
              className="flex items-center gap-2 text-sm font-medium"
            >
              <CreditCard className="text-brand-primary h-4 w-4" />
              College Roll Number <span className="text-brand-primary">*</span>
            </Label>
            <Controller
        ...
        {/* <div className="space-y-2 md:col-span-2">
          <p className="text-sm text-teal-700">
            ...
            <a
              href="/privacy-policy"
              className="underline text-blue-600 hover:text-teal-800"
            >
