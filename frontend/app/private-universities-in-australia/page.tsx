    ...
    <div className="min-h-screen bg-white text-[#242628]">
      ...
      <div className="container mx-auto space-y-20 py-12 lg:py-16">
        ...
        <p className="text-lg font-normal">
          Australia is home to a diverse range of higher education institutions,
          including both public and private universities in Australia. While
          public universities receive government funding, private universities
          operate independently, offering unique advantages such as smaller
          class sizes, industry-focused programs, and personalized learning
          experiences. If you are an international student considering studying
          at a private university in Australia, this guide will help you
        ...
        <section className="flex flex-col justify-center">
          ...
          <p className="mb-2 text-center">
            Private universities in Australia are higher education institutions
            that function independently without direct government funding. They
            offer undergraduate, postgraduate, and professional courses across
            various disciplines. Many private universities have strong industry
            links, allowing students to gain practical experience and networking
            opportunities while studying. Unlike public universities, private
            universities and colleges often have more flexible admission
            requirements and a tailored approach to education. This makes them
            an excellent option for international students looking for
            high-quality education with additional academic support.
          </p>
        ...
        {!error && (
          <section className="flex flex-col justify-center">
            ...
            <p className="mb-2 text-center lg:text-start">
              ...
              offering world-class education and global recognition. Some of the
      ...
      <div className="container mx-auto space-y-20 py-12 lg:py-16">
        <section className="flex flex-col justify-center">
          ...
          <p>
            ...
            supportive environment will find plenty of opportunities at private
            universities in Australia. Whether you choose to study in Sydney,
            Melbourne, or any other city, these institutions offer excellent
            programs to help you achieve your career aspirations.
          </p>
        </section>
